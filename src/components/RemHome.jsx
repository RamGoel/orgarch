...
<section id="testimonials">
    <div class="max-w-6xl px-5 mx-auto mt-32 text-center">
        ...
        <div class="my-16">
            <a href="#" class="p-3 px-6 pt-2 text-white a-colour rounded-full  hover:a-colourLight">Let's connect.</a>
        </div>
    </div>
</section>
...
<section class="a-colour" id="CTA">
    <div class="container flex flex-col items-center justify-between px-6 py-24 mx-auto space-y-12 md:py-12 md:flex-row md:space-y-8">
        ...
        <div class="my-16">
            <a href="#" class="p-3 px-6 pt-2 text-brightRed bg-white rounded-full shadow-2xl hover:bg-gray-300">Let's connect.</a>
        </div>
    </div>
</section>
    </div>
